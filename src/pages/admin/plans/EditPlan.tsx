    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Update subscription plan information</p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Update the information below to modify the subscription plan</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
